...
Uso:
    python tools/align_metrics.py <iter_id>
    python tools/align_metrics.py 02
    python tools/align_metrics.py corpora/iterations/iter_02/kaldi/exp/ali
"""
import re
import sys
...
def resolve_ali_dir(arg: str) -> Path:
    ...
    return ROOT / "corpora" / "iterations" / iter_id / "kaldi" / "exp" / "ali"

...
Salida: `assets/sources/narraciones_mayas_campeche/clean_text/<base>.tsv`

Uso:
    python tools/normalize_narraciones.py
"""
...
from kinai.data_collection.tokenizer import modernize_orthography, normalize_word

SRC_DIR = Path("assets/sources/narraciones_mayas_campeche/text")
OUT_DIR = Path("assets/sources/narraciones_mayas_campeche/clean_text")
